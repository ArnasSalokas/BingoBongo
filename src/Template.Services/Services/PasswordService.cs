...
namespace Template.Services.Services
{
    public class PasswordService : BaseService, IPasswordService
    {
        ...
        {
            var cryptoProvider = _services.GetRngService();
        ...
        public bool ValidatePassword(string password, string correctHash)
        {
            ...
            // Handle random passwords that aren't generated by the service (they will be GUIDs, thus split array length will be one)
            if (split.Length == 1)
                return false;
